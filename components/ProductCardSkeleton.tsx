    ...
    >
      ...
      <div className="space-y-3 p-3 sm:p-5">
        ...
        <div className="flex gap-2 pt-1">
          <div className="h-6 w-14 animate-pulse rounded-md bg-[var(--surface-muted)]" />
          <div className="h-6 w-12 animate-pulse rounded-md bg-[var(--surface-muted)]" />
        </div>
        <div className="h-7 w-24 animate-pulse rounded bg-[var(--surface-muted)] pt-2" />
