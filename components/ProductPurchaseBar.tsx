 ...
 * Account listings: Card + WhatsApp. Top Up: WhatsApp only.
 */
export default function ProductPurchaseBar({
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 border-t border-[var(--border)] bg-[var(--surface)]/95 shadow-[0_-8px_24px_-16px_rgba(0,0,0,0.45)] backdrop-blur-xl lg:hidden">
